...
export default function UploadQuestions() {
    ...
    const downloadSample = async () => {
        try {
            const r = await api.get('/teacher/questions/download-sample', { responseType: 'blob' });
    ...
    return (
        <div className="animate-fade-in" style={{ maxWidth: 720, margin: '0 auto' }}>
            <div style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <button onClick={() => navigate('/teacher/questions')} className="btn-secondary" style={{ padding: '0.6rem 1.25rem' }}>
                    <ArrowLeft size={16} style={{ marginRight: '0.5rem' }} /> Back to Bank
                </button>
            </div>
